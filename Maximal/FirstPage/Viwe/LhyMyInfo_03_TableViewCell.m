...
@interface LhyMyInfo_03_TableViewCell ()
...
@implementation LhyMyInfo_03_TableViewCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        self.labelTotalChche = [[UILabel alloc] init];
        [self.contentView addSubview:self.labelTotalChche];
        self.labelTotalChche.font = [UIFont systemFontOfSize:14];
        self.labelTotalChche.textAlignment = NSTextAlignmentRight;
        self.labelTotalChche.textColor = self.fontColor;
...
- (void)layoutSubviews {
    ...
    self.labelTotalChche.frame = CGRectMake(self.contentView.frame.size.width - 145, self.contentView.frame.size.height / 3, 130, self.contentView.frame.size.height / 3);
